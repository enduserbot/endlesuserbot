...
<p align="center">
    ...
    <br>
        <a href="https://github.com/enduserbot/endlesuserbot/blob/master/README.md#kurulum">Kurulum</a> |
        <a href="https://github.com/enduserbot/endlesuserbot/wiki/G%C3%BCncelleme">Güncelleme</a> |
...
## Kurulum
### Basit Yöntem
Eğer botu kurma hakkında fikriniz yoksa burayı okuyunuz: [Kurulum Rehberi](https://github.com/enduserbot/endlesuserbot/wiki/Kurulum/)

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/enduserbot/endlesuserbot)
### Zor Yöntem
```python
git clone https://github.com/enduserbot/endlesuserbot.git
cd EndlesUserBot
